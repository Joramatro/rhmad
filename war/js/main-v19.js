...
//    	}
    	$.ajax({
	          ...
	          data: {
	        	  ...
	        	  "script61": $("#script61").val(),
	        	  "script62": $("#script62").val(),
	        	  "script71": $("#script71").val(),
	        	  "script72": $("#script72").val(),
	        	  "script81": $("#script81").val(),
	        	  "script82": $("#script82").val(),
	        	  "script91": $("#script91").val(),
	        	  "script92": $("#script92").val(),
	        	  "script101": $("#script101").val(),
	        	  "script102": $("#script102").val(),
	        	  "script111": $("#script111").val(),
