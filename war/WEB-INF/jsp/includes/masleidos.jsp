						...
						<div class="span3">	
							<div class="picture">
								<a href="/cafeteras/${publicacionMVE.url}" title="${publicacionMVE.titulo}">
									...
									<img style="width: 220px;height: 300px;" src="${publicacionMVE.lImages[1]}" alt="${publicacionMVE.titulo}"/>
									</c:if>
									<div class="image-overlay-link"></div>
								</a>
							</div>
							<div class="item-description">
								<h4><a href="/cafeteras/${publicacionMVE.url}">${publicacionMVE.titulo}</a></h4>
								<p>
								...
								<ul class="carousel">
									...
									<li class="testimonial">
										...
										<c:when test="${comentario.publicacion.tipo eq 'EB' }">
											<div class="testimonials-author">${comentario.nombre}, en <a href="/cafeteras/${comentario.publicacion.url }">${comentario.publicacion.titulo}</a></div>
										</c:when>	
										<c:otherwise>
						...
						<div class="span3">	
							<div class="picture">
								<a href="/blog/${publicacionMVA.url}" title="${publicacionMVA.titulo}">
									...
									<img style="width: 220px;height: 300px;" src="${publicacionMVA.lImages[1]}" alt="${publicacionMVA.titulo}"/>
									</c:if>
									<div class="image-overlay-link"></div>
								</a>
							</div>
